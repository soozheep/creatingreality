const SITE_URL = 'https://creatingreality.vercel.app';
  ...
  if (navigator.share) {
    try {
      await navigator.share({
        title: 'Creating Reality — Sonic Remedy | Soozhee',
        text: 'We’re all creating a version of what we see. The one who commits, who dares to begin, shapes their reality. By Soozhee.',
        url: SITE_URL
      });
      return;
    } catch (e) {}
